...
export class GovernanceMonitor extends AbstractMonitor<MonitorType.Governance> {
  @Event(H.ReferendaSubmittedEvent, [Chain.Polkadot, Chain.Kusama, Chain.AssetHubPaseo], 'referenda.Submitted')
  ...
  @Call(H.ConvictionVoteCall, [Chain.Polkadot, Chain.Kusama, Chain.AssetHubPaseo], 'convictionVoting.vote')
